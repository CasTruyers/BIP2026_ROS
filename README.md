...
### Robot position
ros2 topic pub -1 /location_CRJG nav_msgs/msg/Odometry "{pose: {pose: {position: {x: 0.0, y: 0.0}}}}"
...
ros2 topic pub -1 /location_CRJG nav_msgs/msg/Odometry "{pose: {pose: {position: {x: 0.0, y: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.382, w: 0.924}}}}"
